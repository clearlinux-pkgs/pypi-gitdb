...
Source0  : https://files.pythonhosted.org/packages/72/94/63b0fc47eb32792c7ba1fe1b694daec9a63620db1e313033d18140c2320a/gitdb-4.0.12.tar.gz
...
%prep
%setup -q -n gitdb-4.0.12
cd %{_builddir}/gitdb-4.0.12
pushd ..
cp -a gitdb-4.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735830340
